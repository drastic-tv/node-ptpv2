...
exports.init('192.168.50.80', 127, function(){
	synced = exports.is_synced();
	ptpMaster = exports.ptp_master();
	time = exports.ptp_time();
...
http.createServer(function (request, response) {
    ...
    while(!exports.is_synced()) {
        
    }
    // Send the response body as "Hello World"
    response.end("Sync=" + exports.is_synced() + "\nMaster=" + exports.ptp_master() + "\nTime=" + exports.ptp_time() + "\n");
 }).listen(8081);
